...
def scroll_function(driver, last_height):
...
def write_to_file(): 
    ...
    with open('/Users/chloe/Desktop/SRS Project/all_tweets_file.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(["Display Name", "Username", "Tweet Text", "Promoted"])

def append_to_file(actual_tweets): 
    # append tweets to file note: only will do if promoted
    with open('/Users/chloe/Desktop/SRS Project/all_tweets_file.csv', 'a', newline='') as file:
        writer = csv.writer(file)
...
def main():
    ...
    while scrollCount < 15:
        ...
        raw_tweets = scroll_function(driver, height)
